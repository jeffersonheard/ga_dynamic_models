.. ga_dynamic_models documentation master file, created by
   sphinx-quickstart on Thu Mar 29 11:14:36 2012.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

ga_dynamic_models - Dynamic ORM style classes for Django
========================================================
...
dynamically, including ones for `GeoDjango`_, and it will allow you to declare
`TastyPie`_ APIs dynamically, including those that can output GeoJSON via
tastyhacks (ga_ows) is required for this functionality, as it includes
:mod:tastyhacks.py.  Soon you should also be able to use `MongoEngine`_ models.
...
.. _TastyPie: http://django-tastypie.readthedocs.org/en/latest/index.html
.. _GeoDjango: http://www.geodjango.org
